---
name: beta-anl-consulta-movidesk
description: Consultar e sintetizar dados reais do Movidesk com filtros, escopo, paginação e limites de evidência bem definidos.
---
...
Esta skill adapta o contrato original de `SKILL_CONSULTA_MOVIDESK` para o formato Codex. A skill `beta-anl-movidesk` fornece o mapeamento das ferramentas MCP disponíveis no host; esta skill define a intenção analítica, o escopo da consulta e a forma segura de interpretar os resultados. Consulte a fonte original em `references/origem-SKILL_CONSULTA_MOVIDESK-v003.md` quando houver dúvida de rastreabilidade.
